...
void WinScene::EventHandler(sf::RenderWindow &window, sf::Event &event)
{
...
void WinScene::Update(sf::RenderWindow &window, sf::Time deltaTime)
{
...
void WinScene::InitButtonPanels()
{
...
bool WinScene::InitMusic()
{
    if(!_winMusic.openFromFile("Resources/Audio/Fight_Or_Flight_30s.wav"))
    {
