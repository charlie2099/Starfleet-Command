...
void LoseScene::EventHandler(sf::RenderWindow &window, sf::Event &event)
{
...
void LoseScene::Update(sf::RenderWindow &window, sf::Time deltaTime)
{
...
void LoseScene::InitButtonPanels()
{
...
bool LoseScene::InitMusic()
{
    if(!_loseMusic.openFromFile("Resources/Audio/Doomsday_Clock_112bpm_30s.wav"))
    {
