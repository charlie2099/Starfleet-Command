...
OLDStarship::OLDStarship(Type type) : ship_type(type)
{
    switch(type)
    {
        case Type::FIGHTER:
...
void OLDStarship::Update(sf::RenderWindow &window, sf::Time deltaTime)
{
...
void OLDStarship::SetDamage(float damage)
{
    _damage = damage;
}

void OLDStarship::SetSpeed(float speed)
{
    _speed = speed;
}

void OLDStarship::SetAcceleration(float acceleration)
{
    _acceleration = acceleration;
}

void OLDStarship::SetHealthBarVisibility(bool visible)
{
    _healthBarIsVisible = visible;
}

void OLDStarship::MoveTowards(sf::Vector2f target, sf::Time deltaTime)
{
...
void OLDStarship::ShootAt(Projectile::Type projectile, float fireRate, sf::Vector2f target)
{
