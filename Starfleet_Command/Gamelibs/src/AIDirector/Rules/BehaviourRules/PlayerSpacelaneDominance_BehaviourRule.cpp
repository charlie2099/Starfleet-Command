...
PlayerSpacelaneDominance_BehaviourRule::PlayerSpacelaneDominance_BehaviourRule(int maxPlayerStarshipsInLane, std::string ruleID, int rulePriority)
: _numOfPlayerStarshipsInLaneThreshold(maxPlayerStarshipsInLane), _id(std::move(ruleID)), _priority(rulePriority)
{}
