#ifndef STARFLEET_COMMAND_SUPPORTSHIP_HPP
#define STARFLEET_COMMAND_SUPPORTSHIP_HPP
#include <SFML/System/Vector2.hpp>
#include "Interfaces/IStarship.hpp"
#include "Sprites/UI/HealthBar.hpp"
#include "Utility/Vector.hpp"

class SupportShip : public IStarship
{
public:
    explicit SupportShip(int spacelane);
    ...
    bool IsEnemyStarshipAhead(const std::unique_ptr<IStarship> &enemyStarship) override;
