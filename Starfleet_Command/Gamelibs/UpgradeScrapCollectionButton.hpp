#ifndef STARFLEET_COMMAND_UPGRADESCRAPCOLLECTIONBUTTON_HPP
#define STARFLEET_COMMAND_UPGRADESCRAPCOLLECTIONBUTTON_HPP
...
class UpgradeScrapCollectionButton
{
public:
    explicit UpgradeScrapCollectionButton(std::unique_ptr<ScrapMetalManager>& scrapMetalManager, sf::Color hoverColour);
    ~UpgradeScrapCollectionButton() = default;
...
#endif //STARFLEET_COMMAND_UPGRADESCRAPCOLLECTIONBUTTON_HPP
